...
| **Proof it runs** | real paper order filled and closed; 495 offline regression tests; CI green on every push |
...
# 4. Run
python3 -m unittest discover   # 495 offline tests, no credentials needed
